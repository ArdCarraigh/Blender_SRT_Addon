...
def make_it_facing_leave(context):
    ...
    for vert in obj.data.vertices:
        obj.vertex_groups["GeomType"].add([vert.index], 0.80, 'REPLACE')
    ...
    for vert in obj.data.vertices:
        if not vert.groups:
            mesh.vertex_groups["GeomType"].add([vert.index], 0.80, 'REPLACE')
    ...
    temp_mat = bpy.data.materials.new("Material_FacingLeave")
